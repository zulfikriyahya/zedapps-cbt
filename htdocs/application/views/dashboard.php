...
<div class="content-wrapper bg-dark">
    ...
    <section class="content-header p-0 d-flex align-items-end">
        <div class="container-fluid pl-0 pr-0 pb-0 pt-4 bg-dark" >
            <div class="row m-2">
                <?php foreach ($info_box as $info) : ?>
                    <div class="col-md-2 col-4">
                        <div class="shadow small-box bg-maroon">
                            <div class="inner">
                                <h5 class="mb-3"><b><?= $info->total; ?></b></h5>
                    ...
                    <div class="card card-orange my-shadow">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <?php endforeach; ?>
                                <div class="col-md-8 col-12" style="min-height: 60px">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h6 class="text-center text-dark"><b>PENILAIAN HARI INI</b></h6>
                                </div>
