<div class="content-wrapper bg-dark pt-4">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="alert border border-success alert-default-info">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="card-body">
                                            <div class="row mb-4">
                                                ...
                                                echo form_dropdown(
                                                    ...
                                                    $mapels,
                                                    $jks,
                                                    'id="mapel" class="select2 form-control form-control-sm" multiple="multiple" data-placeholder="Pilih Mata Pelajaran"'
                                                ); ?>
                                    ...
                                    <div class="card card-light border border-light">
                                        <div class="card-header bg-maroon">
                                            <span id="keterangan"
                                                  class="card-title text-bold">Tentukan Kelas Mata Pelajaran</span>
                                        </div>
