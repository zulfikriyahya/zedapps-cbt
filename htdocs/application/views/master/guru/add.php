        ...
        <div class="container-fluid">
            ...
            <div class="card my-shadow mb-4">
                <div class="card-header bg-maroon">
                    <h6 class="card-title"><b>Tambah Manual</b></h6>
            ...
            <div class="card my-shadow mb-4">
                ...
                <div class="card-header bg-maroon">
                    <h6 class="card-title"><b>Preview</b></h6>
                    <button name="preview" type="submit" class="btn btn-sm btn-primary card-tools">
                        <i class="fas fa-cloud-upload-alt mr-2"></i>Upload
                    </button>
                </div>
                <?= form_close(); ?>
                <div class="card-body text-dark table-responsive" id="file-preview">
