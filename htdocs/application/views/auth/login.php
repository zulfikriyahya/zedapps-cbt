<div class="container pt-4">
    <div class="container-fluid h-100 pt-4">
        <div class="row h-100 justify-content-center pt-4">
            <div class="login-box">
                <div class="info-box bg-dark shadow-none mt-4">
                    <?php
                    $logo_app = $setting->logo_kanan == null ? base_url() . 'assets/img/favicon.png' : base_url() . $setting->logo_kanan;
                    ?>
                    <img src="<?= $logo_app ?>" width="50" height="50">
                        <div class="info-box-content ml-2">
                            <h2 class="info-box-text text-white font-weight-bold" style="font-family: Arial, sans-serif;"><?= $setting->nama_aplikasi ?></h2>
                        </div>
                </div>

                <div class="card form-signin mt-4" style="font-family: Arial, sans-serif;">
                    <div class="card-body bg-dark rounded-lg" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <?= form_submit('submit', lang('login_submit_btn'), array('id' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat rounded')); ?>
                            </div>
                        </div>
                        <?= form_close(); ?>
                    </div>
